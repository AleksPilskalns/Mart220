...
function setup() {
   ...
   wall = createSprite(900, 500, 222, 1000)
    ...
    icecream2 = createSprite(xRandom, yRandom, 180, 180)
    icecream2.addImage(loadImage('ass/icecream(1).png'))
    icecream3 = createSprite(xRandom, yRandom, 180, 180)
    icecream3.addImage(loadImage('ass/icecream(1).png'))
    icecream4 = createSprite(xRandom, yRandom, 180, 180)
    icecream4.addImage(loadImage('ass/icecream(1).png'))
    icecream5 = createSprite(xRandom, yRandom, 180, 180)
    icecream5.addImage(loadImage('ass/icecream(1).png'))
...
text("you're removing the obstacle!", 800,200,100,200)
    ...
    if(icecream != null)
      {
        if(dist(girlObjects.position.x,girlObjects.position.y,icecream.position.x,icecream.position.y) < 250)
        {
          createParticles(icecream.position.x, icecream.position.y);
          health -= 1;
...
text("you're removing the obstacle!", 800,200,100,200)
    ...
    if(icecream2 != null)
      {
        if(dist(girlObjects.position.x,girlObjects.position.y,icecream2.position.x,icecream2.position.y) < 250)
        {
          createParticles(icecream2.position.x, icecream2.position.y);
          health -= 1;
...
text("you're removing the obstacle!", 800,200,100,200)
    ...
    if(icecream3 != null)
      {
        if(dist(girlObjects.position.x,girlObjects.position.y,icecream3.position.x,icecream3.position.y) < 250)
        {
          createParticles(icecream3.position.x, icecream3.position.y);
          health -= 1;
...
text("you're removing the obstacle!", 800,200,100,200)
    ...
    if(icecream4 != null)
      {
        if(dist(girlObjects.position.x,girlObjects.position.y,icecream4.position.x,icecream4.position.y) < 250)
        {
          createParticles(icecream4.position.x, icecream4.position.y);
          health -= 1;
...
text("you're removing the obstacle!", 800,200,100,200)
    ...
    if(icecream5 != null)
      {
        if(dist(girlObjects.position.x,girlObjects.position.y,icecream5.position.x,icecream5.position.y) < 250)
        {
          createParticles(icecream5.position.x, icecream5.position.y);
          health -= 1;
